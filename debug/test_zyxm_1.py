...
class TestZyxm():
  ...
  def test_zyxm(self):
    ...
    time.sleep(3)
    # 8 | click | css=.children .sl-navitem:nth-child(2) .title | 
    ...
    time.sleep(3)
    # 10 | click | css=.textinput div > div | 
    self.driver.find_element(By.CSS_SELECTOR, ".textinput div > div").click()
    #time.sleep(3)
    # 11 | type | css=.fixed input | test-auto
    self.driver.find_element(By.CSS_SELECTOR, ".fixed input").send_keys("test-auto")
    time.sleep(3)
    # 12 | click | linkText=保存返回 | 
    self.driver.find_element(By.LINK_TEXT, "保存返回").click()
    time.sleep(10)
    # 13 | click | css=.title > .expand | 
    #self.driver.find_element(By.CSS_SELECTOR, ".title > .expand").click()

if __name__ == '__main__':
    pytest.main(['-v','--html=report03.html','test_zyxm_1.py'])