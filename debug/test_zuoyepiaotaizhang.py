...
class TestZuoyepiaotaizhang():
  ...
  def test_zuoyepiaotaizhang(self):
    ...
    # 11 | click | linkText=查看 | 
    self.driver.find_element(By.LINK_TEXT, "查看").click()


if __name__ == '__main__':
  pytest.main(['-v', '--html=report04.html', 'test_zuoyepiaotaizhang.py'])