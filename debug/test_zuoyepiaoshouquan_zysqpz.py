...
class TestZuoyepiaotaizhang_zysqpz():
  ...
  def test_zuoyepiaotaizhang(self):
    ...
    # 22 | click | css=.extnavcontent .sl-navitem:nth-child(2) .title | 
    self.driver.find_element(By.CSS_SELECTOR, ".extnavcontent .sl-navitem:nth-child(2) .title").click()
    time.sleep(2)
    # 23 | click | linkText=添加 | 
    self.driver.find_element(By.LINK_TEXT, "添加").click()
    time.sleep(2)
    # 24 | click | linkText=返回 | 
    self.driver.find_element(By.LINK_TEXT, "返回").click()
  
if __name__ == '__main__':
    pytest.main(['-v','--html=report03.html','test_zuoyepiaoshouquan_zysqpz.py'])