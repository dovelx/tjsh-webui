...
class TestZuoyepiaotaizhang_kbsqr():
  ...
  def test_zuoyepiaotaizhang_kbsqr(self):
    # Test name: zuoyepiaotaizhang
    ...
    # 18 | click | css=.sl-navitem:nth-child(1) .title | 
    self.driver.find_element(By.CSS_SELECTOR, ".sl-navitem:nth-child(1) .title").click()
    time.sleep(2)
    self.driver.find_element(By.XPATH,
                             "/html/body/div[1]/div/div[2]/div[1]/div/div[2]/div/div[1]/div/ul/li[1]/div/ul/li[11]/span/span").click()
    time.sleep(2)
    # 19 | click | css=.extnavcontent .sl-navitem:nth-child(1) .title | 
    self.driver.find_element(By.CSS_SELECTOR, ".extnavcontent .sl-navitem:nth-child(1) .title").click()
    # 20 | click | linkText=添加 | 
    self.driver.find_element(By.LINK_TEXT, "添加").click()
    time.sleep(2)
    # 21 | click | linkText=返回 | 
    self.driver.find_element(By.LINK_TEXT, "返回").click()

  
if __name__ == '__main__':
    pytest.main(['-v','--html=report03.html','test_zuoyepiaoshouquan_kbsqr.py'])