...
class TestGuanbiyichangzuoyepiaotaizhang():
  ...
  def test_guanbiyichangzuoyepiaotaizhang(self):
    # Test name: guanbiyichangzuoyepiaotaizhang
    ...
    # 3 | click | css=.account | 
    self.driver.find_element(By.CSS_SELECTOR, ".account").click()
    # 4 | click | id=name | 
    self.driver.find_element(By.ID, "name").click()
    # 5 | type | id=name | zhai
    self.driver.find_element(By.ID, "name").send_keys("zhai")
    # 6 | type | id=pwd1 | 123456
    ...
    time.sleep(3)
    # 10 | click | css=.children .sl-navitem:nth-child(12) .title | 
    self.driver.find_element(By.CSS_SELECTOR, ".children .sl-navitem:nth-child(12) .title").click()
    time.sleep(3)
    # 11 | click | css=.selected > .check > .value | 
...
if __name__ == '__main__':
    pytest.main(['-v','--html=report01.html','test_guanbiyichangzuoyepiaotaizhang.py'])
