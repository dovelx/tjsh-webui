...
class jsaPageElements:
    def __init__(self):
        self.path = '/portals/tjsh#eyJtYyI6ImhzZSIsImZjIjoiSFNFX1NBRkVUWV9BTkFMWVNJU19ORVciLCJ1YyI6IjAxMzA0MDAwIn0='
        ...
        self.fuxuankuang = CreateElement.create(Locator_Type.XPATH,
                                           '/html/body/div[1]/div/div[2]/div[2]/div[3]/div/div[1]/div[3]/div/div[2]/div[3]/div[1]/div/div[4]/table/tbody/tr[1]/td[1]/span',
                                           wait_type=Wait_By.PRESENCE_OF_ELEMENT_LOCATED)
        self.suoshubumen = CreateElement.create(Locator_Type.XPATH,
                                                '/html/body/div[1]/div/div[2]/div[2]/div[3]/div/div[1]/div[2]/div/div/div/div/div[1]/div/table/tbody/tr[1]/td[3]/span[2]/div/i',
                                                wait_type=Wait_By.PRESENCE_OF_ELEMENT_LOCATED)
        self.zuoyemingcheng = CreateElement.create(Locator_Type.XPATH,
                                                '/html/body/div[1]/div/div[2]/div[2]/div[3]/div/div[1]/div[2]/div/div/div/div/div[1]/div/table/tbody/tr[1]/td[2]/span[2]/div/div',
                                                wait_type=Wait_By.PRESENCE_OF_ELEMENT_LOCATED)
