...
class shigongzuoyepiaoPageElements:
    def __init__(self):
        self.path = '/hses/tjsh#eyJtYyI6ImhzZSIsImZjIjoiSFNFX1dPUktfVElDS0VUX0dCX1NHWlkiLCJ1YyI6IjAxMzA5MDAwIn0='
        ...
        self.zuoyemingcheng = CreateElement.create(Locator_Type.XPATH,
                                                '/html/body/div[1]/div/div[2]/div[2]/div[3]/div/div/div[2]/div/div/div/div/div[1]/div/table/tbody/tr[1]/td[3]/span[2]/div/div',
                                                wait_type=Wait_By.PRESENCE_OF_ELEMENT_LOCATED)
        self.suoshubumen = CreateElement.create(Locator_Type.XPATH,
                                                '/html/body/div[1]/div/div[2]/div[2]/div[3]/div/div/div[2]/div/div/div/div/div[1]/div/table/tbody/tr[1]/td[2]/span[2]/div/div',
                                                wait_type=Wait_By.PRESENCE_OF_ELEMENT_LOCATED)
